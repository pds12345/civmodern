...
import sh.okx.civmodern.common.mixins.GuiGraphicsAccessor;
import sh.okx.civmodern.common.ui.event.WindowResizeCallback;
import sh.okx.civmodern.common.ui.renderstate.CircleElementRenderState;
import sh.okx.civmodern.common.ui.renderstate.GradientQuadElementRenderState;
...
public class OwoUIGraphics extends GuiGraphics {
    ...
    public static final Identifier PANEL_NINE_PATCH_TEXTURE = CivModernUI.id("panel/default");
    public static final Identifier DARK_PANEL_NINE_PATCH_TEXTURE = CivModernUI.id("panel/dark");
    public static final Identifier PANEL_INSET_NINE_PATCH_TEXTURE = CivModernUI.id("panel/inset");
    ...
    public static OwoUIGraphics of(GuiGraphics graphics) {
        var owoContext = new OwoUIGraphics(
            ...
            ((GuiGraphicsAccessor) graphics).civmodern$getMouseY(),
            ((GuiGraphicsAccessor) graphics).civmodern$getMouseX(),
            ((GuiGraphicsAccessor) graphics)::civmodern$setDeferredTooltip
        );

        ((GuiGraphicsAccessor) owoContext).civmodern$setScissorStack(((GuiGraphicsAccessor) graphics).civmodern$getScissorStack());
        ((GuiGraphicsAccessor) owoContext).civmodern$setPose(((GuiGraphicsAccessor) graphics).civmodern$getPose());
    ...
    public void drawTooltip(Font textRenderer, int x, int y, List<ClientTooltipComponent> components, @Nullable Identifier texture) {
        ((GuiGraphicsAccessor) this).civmodern$drawTooltipImmediately(textRenderer, components, x, y, DefaultTooltipPositioner.INSTANCE, texture);
    }
    ...
    protected void setTooltipForNextFrameInternal(Font textRenderer, List<ClientTooltipComponent> components, int x, int y, ClientTooltipPositioner positioner, @Nullable Identifier texture, boolean focused) {
        ...
        this.setTooltipDrawer.accept(((GuiGraphicsAccessor) this).civmodern$getDeferredTooltip());
    }
