...
import sh.okx.civmodern.common.ui.util.CursorAdapter;
 ...
 * even if you choose to not use {@link sh.okx.civmodern.common.ui.base.BaseOwoScreen}
 ...
 *
 * @see sh.okx.civmodern.common.ui.base.BaseOwoScreen
 */
public class OwoUIAdapter<R extends ParentUIComponent> implements GuiEventListener, Renderable, NarratableEntry {
    ...
    public boolean keyPressed(KeyEvent input) {
        if (CivModernUI.DEBUG && input.key() == GLFW.GLFW_KEY_LEFT_SHIFT) {
