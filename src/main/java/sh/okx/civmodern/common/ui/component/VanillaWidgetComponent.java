...
public class VanillaWidgetComponent extends BaseUIComponent {
    ...
    protected int determineVerticalContentSize(Sizing sizing) {
        if (this.widget instanceof Button || this.widget instanceof Checkbox) {
            ...
            if (((EditBoxAccessor) textField).civmodern$bordered()) {
                return 20;
            } else {
                return 9;
            }
    ...
    private void applyToWidget() {
        ...
        accessor.civmodern$setX(this.x + this.widget.xOffset());
        accessor.civmodern$setY(this.y + this.widget.yOffset());

        accessor.civmodern$setWidth(this.width + this.widget.widthOffset());
        accessor.civmodern$setHeight(this.height + this.widget.heightOffset());
    }
